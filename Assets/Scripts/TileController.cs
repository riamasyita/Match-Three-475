...
public class TileController : MonoBehaviour
{
    ...
    private static readonly Vector2 sizeBig = Vector2.one * 1.5f;
    private static readonly Vector2 sizeSmall = Vector2.zero * 1f;
    private static readonly Vector2 sizeNormal = Vector2.one * 1.2f;
